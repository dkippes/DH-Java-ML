...
public class ApiExceptionControllerAdvice {
    ...
    public ErrorMessage timetableException(TimeTableNotFoundException ex) {
    ...
    @ResponseBody
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorMessage dateException(DateErrorException ex) {
        return new ErrorMessage(HttpStatus.BAD_REQUEST.value(), ex.ERROR);
    }
    ...
    @ResponseBody
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorMessage dentistNotFound(DentistNotFoundException ex) {
        return new ErrorMessage(HttpStatus.BAD_REQUEST.value(), ex.ERROR);
    }
    ...
    @ResponseBody
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorMessage patientNotFound(PatientNotFoundException ex) {
        return new ErrorMessage(HttpStatus.BAD_REQUEST.value(), ex.ERROR);
    }
