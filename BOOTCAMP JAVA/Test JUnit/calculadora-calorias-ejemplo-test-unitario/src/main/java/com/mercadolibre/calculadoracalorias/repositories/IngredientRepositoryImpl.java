...
public class IngredientRepositoryImpl implements IngredientRepository {
  ...
  @Override
  public IngredientDTO findIngredientByName(String name) throws NotFoundException {
    return database.stream().filter(I -> I.getName().equals(name)).findFirst().orElseThrow(NotFoundException::new);
