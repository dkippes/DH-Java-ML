...
public class PlatoServiceImpl implements IPlatoService {
  ...
  public PlatoServiceImpl(IngredientRepository ingredientRepository) {
    this.ingredientRepository = ingredientRepository;
  }

  @Override
  public PlatoResponseDTO calculateCalories(PlatoDTO dish) {
    PlatoResponseDTO response = new PlatoResponseDTO(dish);
    int total = 0;
    int maxCalories = 0;
  ...
  @Override
  public List<PlatoResponseDTO> calculateAllCalories(List<PlatoDTO> dishes) {
    List<PlatoResponseDTO> result = new ArrayList<>();
    for (PlatoDTO dish : dishes) {
